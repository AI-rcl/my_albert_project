...
BOTS_DIR=os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))),'bots')
bot_name=sys.argv[-1]
bot_path=os.path.join(BOTS_DIR,bot_name)
model_path=os.path.join(bot_path,'model')
num_labels=len(sys.argv[-2].split(','))
...
if __name__ == '__main__':
    args = {'bert_model_dir': BERT_BASE_DIR,
    ...
    #                     help='chinese google bert model_data path')
    # parser.add_argument('-model_dir', type=str, required=True,
    #                     help='directory of a pretrained BERT model_data')
    # parser.add_argument('-model_pb_dir', type=str, default=None,
    #                     help='directory of a pretrained BERT model_data,default = model_dir')
